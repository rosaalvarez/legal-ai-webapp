...
st.set_page_config(page_title="Private Legal AI Assistant", page_icon="🔒", layout="wide")
if st.secrets.get("APP_PASSWORD") != st.text_input("Team password", type="password"):
    st.title("🔒 Private Legal AI Assistant")
    st.caption("Enter the password to access the app.")
    st.stop()

st.title("⚖️ Private Legal AI Assistant")
st.caption("Internal legal review workspace for team-only use.")
